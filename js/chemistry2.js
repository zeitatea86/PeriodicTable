...
/// Generating DIVs *****************
let arrElements = {
  20: "H", 37: "He", 39: "Li", 40: "Be", 51: "B", 52: "C", 53: "N", 54: "O", 55: "F",
  56: "Ne", 58: "Na", 59: "Mg", 70: "Al", 71: "Si", 72: "P", 73: "S", 74: "Cl", 75: "Ar", 77: "K", 78: "Ca",
  79: "Sc", 80: "Ti", 81: "V", 82: "Cr", 83: "Mn", 84: "Fe", 85: "Co", 86: "Ni", 87: "Cu", 88: "Zn", 89: "Ga",
  90: "Ge", 91: "As", 92: "Se", 93: "Br", 94: "Kr", 96: "Rb", 97: "Sr", 98: "Y", 99: "Zr", 100: "Nb", 101: "Mo",
  102: "Tc", 103: "Ru", 104: "Rh", 105: "Pd", 106: "Ag", 107: "Cd", 108: "In", 109: "Sn", 110: "Sb", 111: "Te",
  112: "I", 113: "Xe", 115: "Cs", 116: "Ba", 118: "Hf", 119: "Ta", 120: "W", 121: "Re", 122: "Os",
  123: "Ir", 124: "Pt", 125: "Au", 126: "Hg", 127: "Tl", 128: "Pb", 129: "Bi", 130: "Po", 131: "At", 132: "Rn",
  134: "Fr", 135: "Ra", 137: "Rf", 138: "Db", 139: "Sg", 140: "Bh", 141: "Hs", 142: "Mt", 143: "Ds",
  144: "Rg", 145: "Cn", 146: "Nh", 147: "Fl", 148: "Mc", 149: "Lv", 150: "Ts", 151: "Og", 156: "La",
  157: "Ce", 158: "Pr", 159: "Nd", 160: "Pm", 161: "Sm", 162: "Eu", 163: "Gd", 164: "Tb", 165: "Dy", 166: "Ho",
  167: "Er", 168: "Tm", 169: "Yb", 170: "Lu", 175: "Ac", 176: "Th", 177: "Pa", 178: "U", 179: "Np",
...
let all = document.getElementsByClassName("elements");
for (let i = 0; i < all.length; i++) {
  if (arrElements.hasOwnProperty(i)) {
    ...
    if (i === 0) {
      all[i].innerHTML = '<p id="grupa">GRUPA</p><br><p id="perioada">PERIOADA</p>';
    } else if (i < 19) {
      all[i].innerHTML = i;
      all[i].classList.add("firstRow");
    } else if (i % 19 === 0) {
      if (i / 19 != 8 && i / 19 != 9) {
        all[i].innerHTML = i / 19;
        all[i].classList.add("firstColumn");
      } else {
        all[i].innerHTML = i;
...
let allElements = document.getElementsByClassName("elementsFinal");
let parsedElementsList = {};
for (let i = 0; i < allElements.length; i++) {
  let AtomicNumber = elementsList.Table.Row[i].Cell[0];
  let Symbol = elementsList.Table.Row[i].Cell[1];
  let Name = elementsList.Table.Row[i].Cell[2];
  let AtomicMass = elementsList.Table.Row[i].Cell[3];
  let CPKHexColor = elementsList.Table.Row[i].Cell[4];
  let ElectronConfiguration = elementsList.Table.Row[i].Cell[5];
  let Electronegativity = elementsList.Table.Row[i].Cell[6];
  let AtomicRadius = elementsList.Table.Row[i].Cell[7];
  let IonizationEnergy = elementsList.Table.Row[i].Cell[8];
  let ElectronAffinity = elementsList.Table.Row[i].Cell[9];
  let OxidationStates = elementsList.Table.Row[i].Cell[10];
  let StandardState = elementsList.Table.Row[i].Cell[11];
  let MeltingPoint = elementsList.Table.Row[i].Cell[12];
  let BoilingPoint = elementsList.Table.Row[i].Cell[13];
  let Density = elementsList.Table.Row[i].Cell[14];
  let GroupBlock = elementsList.Table.Row[i].Cell[15];
  let YearDiscovered = elementsList.Table.Row[i].Cell[16];
  parsedElementsList[Symbol] = [AtomicNumber, Symbol, Name, AtomicMass, CPKHexColor, ElectronConfiguration, Electronegativity,
    AtomicRadius, IonizationEnergy, ElectronAffinity, OxidationStates, StandardState, MeltingPoint,
    BoilingPoint, Density, GroupBlock, YearDiscovered];
}

for (let i = 0; i < allElements.length; i++) {
  allElements[i].innerHTML = "<p>" + parsedElementsList[allElements[i].innerHTML][0] + '</p>' +
    '<p style="font-size: 20px;font-weight: bolder;">' + parsedElementsList[allElements[i].innerHTML][1] + '</p>' +
    '<p>' + parsedElementsList[allElements[i].innerHTML][2] + '</p>' +
    '<p>' + parsedElementsList[allElements[i].innerHTML][3] + '</p>'
    ;
}
